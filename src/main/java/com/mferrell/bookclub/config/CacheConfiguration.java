package com.mferrell.bookclub.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mferrell.bookclub.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mferrell.bookclub.repository.UserRepository.USERS_BY_EMAIL_CACHE);
