...
/**
 * REST controller for managing {@link com.mferrell.bookclub.domain.Book}.
 */
@RestController
@RequestMapping("/api")
public class BookResource {
    ...
    public BookResource(BookService bookService, ChapterService chapterService) {
    ...
    public List<ChapterDTO> getBookChapters(@PathVariable Long id) {
        log.debug("REST request to get Book : {}", id);
